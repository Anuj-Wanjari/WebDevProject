const currencyOne = document.getElementById("from-currency");
const amountOne = document.getElementById("amount-from");
const currencyTwo = document.getElementById("to-currency");
const amountTwo = document.getElementById("amount-to");
